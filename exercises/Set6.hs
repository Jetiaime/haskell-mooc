...
instance Eq RationalNumber where
  RationalNumber qa qb == RationalNumber pa pb = qa * pb == qb * pa
...
instance Num RationalNumber where
  (RationalNumber qa qb) + (RationalNumber pa pb) = simplify $ RationalNumber (qa * pb + pa * qb) (qb * pb)
  (RationalNumber qa qb) * (RationalNumber pa pb) = simplify $ RationalNumber (qa * pa) (qb * pb)
